...
${message}
   <form action ="validate" method="post">
      ...
      <p class="subtitle">Don't have an account? <a href="register" formmethod="post" formaction="registration"> sign Up</a></p>
      ...
      <button class="cta-btn" formmethod="post" formaction="validate">Log In</button>
      <a class="forget-pass" href="forgatepassword">Forgot password?</a>
   </form>
</div>
<style>
